...
gs = fig.add_gridspec(nrows=2, ncols=1, height_ratios=[1,1], hspace=0.7)
...
position3 = [(16.8, 8.6), (27.2, 8.2), (2.4, 4.5)]
ax2.clabel(CS2, inline=True, fontsize=13, manual=position3, fmt=lambda x: f'dVs = {x:.0f}%')
...
# descriptions
ax2.text(24.3,1,'PzP reflectivity',fontsize=12,fontname='Nimbus Sans',weight='bold')
...
#position3 = [(16.8, 8.6), (27.2, 8.2), (1.2, 4.5)]
position3 = [(16.8, 8.6), (27.2, 8.2), (2.4, 4.5)]
ax3.clabel(CS3, inline=True, fontsize=13, manual=position3, fmt=lambda x: f'dVs = {x:.0f}%')
...
# descriptions
ax3.text(24.3,1,'PzS reflectivity',fontsize=12,fontname='Nimbus Sans',weight='bold')


if show:
    plt.show()
else:
    fig.savefig('./figs/pp_ps_images.pdf', dpi=300, facecolor='w', bbox_inches='tight')
