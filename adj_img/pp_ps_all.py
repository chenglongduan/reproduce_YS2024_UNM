...
pic1 = ax2.imshow(ppimg_norm, cmap="jet_r", vmin=-0.52, vmax=0.52, extent=(x[0],x[-1],z[-1],z[0]), interpolation='none', aspect='equal')
ax2.set_xlabel('Distance (km)',fontsize=15)
ax2.set_ylabel('Depth (km)',fontsize=15)

# plot contours
CS2 = ax2.contour(interp_x.T, interp_z.T, reflec_perc, [-30, -25], colors='black', linewidths=0.7)
position3 = [(16.8, 8.6), (27.2, 8.2)]
...
pic2 = ax3.imshow(psimg_norm, cmap="jet_r", vmin=-0.42, vmax=0.42, extent=(x[0],x[-1],z[-1],z[0]), interpolation='none', aspect='equal')
ax3.set_xlabel('Distance (km)',fontsize=15)
ax3.set_ylabel('Depth (km)',fontsize=15)

# plot contours
CS3 = ax3.contour(interp_x.T, interp_z.T, reflec_perc, [-30, -25], colors='black', linewidths=0.7)
position3 = [(16.8, 8.6), (27.2, 8.2)]
