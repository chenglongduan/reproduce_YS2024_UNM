...
# input parameters-----------------------------------------------------------------------------------------------------
file_pp = '/home0/cxd170430/NatureGeo/adj_img/data/Kz_vz_pp_dt0_final.rsf@'
file_ps = '/home0/cxd170430/NatureGeo/adj_img/data/Kz_R_plus_T_final.rsf@'
...
gs = fig.add_gridspec(nrows=2, ncols=1, height_ratios=[1,1], hspace=0.6)


# PP image
ax2 = fig.add_subplot(gs[0,0])
pic1 = ax2.imshow(ppimg_norm, cmap="Blues", vmin=0, vmax=0.4, extent=(x[0],x[-1],z[-1],z[0]), interpolation='none', aspect='auto')
ax2.set_ylim(4,0)
ax2.set_xlabel('Distance (km)',fontsize=15)
ax2.set_ylabel('Wavenumber (1/km)',fontsize=15)

# colorbars look
cbar2=fig.colorbar(pic1, ax=ax2, location='right', orientation='vertical', shrink=0.7, anchor=(-0.1,0.5))
cbar2.set_label('Amplitude',fontsize=13)
cbar2.set_ticks([0,0.2,0.4])
cbar2.ax.tick_params(labelsize=13, length=5, width=1.2)
cbar2.ax.yaxis.set_minor_locator(AutoMinorLocator(n=5))
cbar2.ax.tick_params(which='minor', length=5, width=1.2)
...
# ticks look
ax2.tick_params(which='minor', length=3.8, width=1.2, top=True, right=True)
ax2.tick_params(width=1.2)
# frame look
plt.setp(ax2.spines.values(), linewidth=1.2)
# annotations
ax2.annotate('', xy=(0,0), xycoords='data', xytext=(0,-0.55), textcoords='data', size=13,
             arrowprops=dict(arrowstyle="-",facecolor='black',linewidth=1.4))
ax2.annotate('', xy=(30,0), xycoords='data', xytext=(30,-0.55), textcoords='data', size=13,
             arrowprops=dict(arrowstyle="-",facecolor='black',linewidth=1.4))
ax2.text(-0.35, -0.7, 'X', fontsize=15)
ax2.text(29.65, -0.7, 'X$^{\prime}$', fontsize=15)
...
pic2 = ax3.imshow(psimg_norm, cmap="Blues", vmin=0, vmax=0.4, extent=(x[0],x[-1],z[-1],z[0]), interpolation='none', aspect='auto')
ax3.set_ylim(4,0)
ax3.set_xlabel('Distance (km)',fontsize=15)
ax3.set_ylabel('Wavenumber (1/km)',fontsize=15)

# colorbars look
cbar3=fig.colorbar(pic2, ax=ax3, location='right', orientation='vertical', shrink=0.7, anchor=(-0.1,0.5))
cbar3.set_label('Amplitude',fontsize=13)
cbar3.set_ticks([0,0.2,0.4])
cbar3.ax.tick_params(labelsize=13, length=5, width=1.2)
cbar3.ax.yaxis.set_minor_locator(AutoMinorLocator(n=4))
cbar3.ax.tick_params(which='minor', length=5, width=1.2)
...
# ticks look
ax3.tick_params(which='minor', length=3.8, width=1.2, top=True, right=True)
ax3.tick_params(width=1.2)
# frame look
plt.setp(ax3.spines.values(), linewidth=1.2)
# annotations
ax3.annotate('', xy=(0,0), xycoords='data', xytext=(0,-0.55), textcoords='data', size=13,
             arrowprops=dict(arrowstyle="-",facecolor='black',linewidth=1.4))
ax3.annotate('', xy=(30,0), xycoords='data', xytext=(30,-0.55), textcoords='data', size=13,
             arrowprops=dict(arrowstyle="-",facecolor='black',linewidth=1.4))
ax3.text(-0.35, -0.7, 'X', fontsize=15)
ax3.text(29.65, -0.7, 'X$^{\prime}$', fontsize=15)
